...
@Component({
    selector: 'app-reasignar-turnos-tramite',
...
export class ReasignarTurnosComponent  {
    ...
    toggle(grupoTramite: GrupoTramiteAccordion ) {
        if (!grupoTramite.modified) {
            ...
            this.reasignarTurnosService.obtenerGrupoDeTramite(this.idPuntoAtencion, grupoTramite.id, this.fecha, this.idTramite).subscribe(value => {
                value.cata((errors) => {
