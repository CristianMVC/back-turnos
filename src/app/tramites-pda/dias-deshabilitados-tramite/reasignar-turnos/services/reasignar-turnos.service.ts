...
export class ReasignarTurnoService {
    ...
    obtenerGrupoDeTramite(puntoAtencionId: number, grupoTramiteId: number, fecha: string, idTramite: number) {
        return this.http.getTransformer(`turnos/${puntoAtencionId}/reasignacion/${grupoTramiteId}/tramite/${idTramite}`,
