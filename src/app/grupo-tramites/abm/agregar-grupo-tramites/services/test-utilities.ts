...
@Injectable()
export class TestHelperGrupoTramites {
    ...
    createNuevoGrupoTramites(puntoId: number, tramiteId: number): NuevoGrupoTramitesForm {

        return {
            nombre: 'nombre test',
            horizonte: 10,
            intervalo: 30, // TODO: Usar intervaloService.
            id: 0,
    ...
    createGrupoTramitesEditar(puntoId: number, grupoId: number, tramiteId: number): NuevoGrupoTramitesForm {
        return {
